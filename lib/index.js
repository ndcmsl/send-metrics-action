...
const dev = (0, core_1.getInput)('dev');
const infra = (0, core_1.getInput)('infra');
const microservice = (0, core_1.getInput)('microservice');
const version = (0, core_1.getInput)('version');
const config = (0, core_1.getInput)('config');
...
async function sendMetrics() {
    ...
    const response = await (0, node_fetch_1.default)(`http://${host}/Api/PushGateway/SetMetrics`, {
        method: 'post',
